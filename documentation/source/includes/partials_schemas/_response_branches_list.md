...
| openingTime       | [[TimeString](#commonFieldTimeString)] | Não         | Horário padrão de início de atendimento da Dependência.          |
| closingTime       | [[TimeString](#commonFieldTimeString)] | Não         | Horário padrão de encerramento de atendimento da Dependência.    |
